...
public class Sprite {
	...
	public static Sprite spawn_grass = new Sprite(32, 0, 0, SpriteSheet.spawn_level);
	public static Sprite spawn_water = new Sprite(32, 1, 0, SpriteSheet.spawn_level);
	public static Sprite spawn_stone = new Sprite(32, 2, 0, SpriteSheet.spawn_level);
	public static Sprite spawn_stonewall = new Sprite(32, 0, 1, SpriteSheet.spawn_level);
	public static Sprite spawn_colorwall = new Sprite(32, 0, 2, SpriteSheet.spawn_level);
	public static Sprite spawn_woodfloor = new Sprite(32, 1, 1, SpriteSheet.spawn_level);
